...
const allClearTodo = document.querySelector("#clearButton");
const filterTodo = document.querySelector("#todoSearch");
...
function runEvents(){
    ...
    allClearTodo.addEventListener("click",removeTodoAll);
...
function filter(e){
    ...
    if(todoListesi.length>0){
        ...
        showAlert("warning","Arama sonucuna ulaşılamadı.");
    }
}
...
function removeTodoToUI(e){
    if(e.target.className==="fa fa-remove"){
        ...
        showAlert("Todo başarıyla silindi.");
    }
}
